...
export const INITIAL_SUBJECTS = [
  ...
  {
    id: 'subj_computer_literacy',
    examId: 'exam_fda_sda_2026',
    name: 'ಕಂಪ್ಯೂಟರ್ ಸಾಕ್ಷರತೆ (Computer Literacy)',
    nameKn: 'ಕಂಪ್ಯೂಟರ್ ಸಾಕ್ಷರತೆ',
    description: 'ಕಂಪ್ಯೂಟರ್ ಮೂಲಭೂತ ಜ್ಞಾನ, ಎಂಎಸ್ ಆಫೀಸ್ (Word, Excel, PowerPoint), ಇಂಟರ್ನೆಟ್, ಸೈಬರ್ ಭದ್ರತೆ ಮತ್ತು ಇತ್ತೀಚಿನ ತಂತ್ರಜ್ಞಾನಗಳು.',
    icon: 'Cpu',
    imageUrl: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=800&auto=format&fit=crop&q=80',
    colorGradient: 'from-indigo-600 via-cyan-700 to-blue-800',
    badge: 'ಕಡ್ಡಾಯ ಅರ್ಹತಾ ಪರೀಕ್ಷೆ',
    topics: ['Computer Basics & Architecture', 'MS Office (Word, Excel, PPT)', 'Operating Systems & Networking', 'Cyber Security & Privacy', 'Internet & Email Basics'],
    order: 7
  }
];
...
// Community Study & Collaborate Repository (User & Educator uploaded PYQs, Notes, Book Summaries)
export const INITIAL_COMMUNITY_MATERIALS = [
  {
    id: 'comm_pyq_psi_2024',
    title: '2024 Karnataka PSI Exam Question Paper & Official Answer Key (Solved)',
    titleKn: '2024 ಕರ್ನಾಟಕ PSI ಪರೀಕ್ಷೆ ಪ್ರಶ್ನೆಪತ್ರಿಕೆ & ಅಧಿಕೃತ ಕೀ-ಉತ್ತರಗಳು (Paper 1 & Paper 2 Solved)',
    category: 'pyq', // 'pyq' | 'notes' | 'book_summary' | 'model_paper'
    examId: 'exam_psi_pc_2026',
    examName: 'Karnataka PSI & Police',
    examNameKn: 'ಕರ್ನಾಟಕ ಪಿ.ಎಸ್.ಐ & ಪೊಲೀಸ್',
    subject: 'General Studies & Mental Ability',
    subjectKn: 'ಸಾಮಾನ್ಯ ಜ್ಞಾನ & ಮಾನಸಿಕ ಸಾಮರ್ಥ್ಯ',
    year: '2024',
    description: 'Original question paper with verified official answer keys and detailed step-by-step reasoning for Karnataka Civil PSI exam.',
    descriptionKn: '2024 ರಲ್ಲಿ ನಡೆದ ಸಿವಿಲ್ ಪಿಎಸ್‌ಐ ಪರೀಕ್ಷೆಯ ಮೂಲ ಪ್ರಶ್ನೆಪತ್ರಿಕೆ ಮತ್ತು ಕೆಪಿಎಸ್‌ಸಿ ಅಧಿಕೃತ ಕೀ ಉತ್ತರಗಳ ಸಹಿತ ವಿವರಣೆ.',
    contributorName: 'ಮಹೇಶ್ ಕುಮಾರ್ (Mahesh Kumar)',
    contributorDistrict: 'Dharwad (ಧಾರವಾಡ)',
    contributorBadge: 'Verified Topper',
    fileUrl: 'https://kpsc.kar.nic.in/PSI_2024_Paper.pdf',
    fileType: 'pdf',
    fileSize: '4.2 MB',
    upvotes: 142,
    downloads: 680,
    ...
    tags: ['PSI 2024', 'Official Key', 'Solved PYQ', 'Dharwad Notes']
  },
  {
    id: 'comm_notes_polity_handwritten',
    title: 'Indian Constitution - Key Articles & Amendments Handwritten Short Notes',
    titleKn: 'ಭಾರತದ ಸಂವಿಧಾನ - ಪ್ರಮುಖ ವಿಧಿಗಳು & ತಿದ್ದುಪಡಿಗಳ ಕೈಬರಹದ ಶಾರ್ಟ್ ನೋಟ್ಸ್',
    category: 'notes',
    examId: 'exam_kas_2026',
    examName: 'KPSC KAS / PSI / PDO',
    examNameKn: 'ಕೆ.ಪಿ.ಎಸ್.ಸಿ ಕೆಎಎಸ್ / ಪಿಎಸ್ಐ',
    subject: 'Indian Polity & Constitution',
    subjectKn: 'ಭಾರತದ ಸಂವಿಧಾನ & ರಾಜಕೀಯ',
    year: '2026',
    description: 'Quick revision handwritten guide covering Article 1 to 395, Fundamental Rights, Writs, and 1st to 106th Constitutional Amendments.',
    descriptionKn: '1 ರಿಂದ 395 ರವರೆಗಿನ ಅತಿ ಮುಖ್ಯ ವಿಧಿಗಳು, ಮೂಲಭೂತ ಹಕ್ಕುಗಳು, ರಿಟ್‌ಗಳು ಮತ್ತು 1 ರಿಂದ 106 ನೇ ತಿದ್ದುಪಡಿಗಳ ಸರಳ ಕೈಬರಹದ ಶಾರ್ಟ್ ನೋಟ್ಸ್.',
    contributorName: 'ಪ್ರಿಯಾಂಕಾ ಬಿ.ಆರ್ (Priyanka B.R)',
    contributorDistrict: 'Mysuru (ಮೈಸೂರು)',
    contributorBadge: 'Star Contributor',
    ...
    tags: ['Constitution', 'Handwritten', 'Articles 1-395', 'Revision']
  },
  {
    id: 'comm_book_pdo_panchayat_raj',
    title: 'Karnataka Gram Swaraj & Panchayat Raj Act 1993 - Chapter-wise Summary (PDO Guide)',
    titleKn: 'ಕರ್ನಾಟಕ ಗ್ರಾಮ ಪಂಚಾಯತ್ ರಾಜ್ ಅಧಿನಿಯಮ 1993 - ಅಧ್ಯಾಯವಾರು ಸಾರಾಂಶ (PDO Guide)',
    category: 'book_summary',
    examId: 'exam_pdo_2026',
    examName: 'Karnataka PDO & Grama Adhikari',
    examNameKn: 'ಪಿ.ಡಿ.ಒ & ಗ್ರಾಮ ಆಡಳಿತಾಧಿಕಾರಿ',
    subject: 'Rural Development & Panchayat Raj',
    subjectKn: 'ಗ್ರಾಮೀಣಾಭಿವೃದ್ಧಿ & ಪಂಚಾಯತ್ ರಾಜ್',
    year: '2026',
    description: 'Essential summary of all chapters, sections, taxation rules, and the 73rd constitutional amendment directly mapped to PDO syllabus.',
    descriptionKn: 'ಪಿಡಿಒ ಪರೀಕ್ಷೆಗೆ ಅತ್ಯಗತ್ಯವಾದ ಪಂಚಾಯತ್ ರಾಜ್ ಕಾಯ್ದೆಯ ಎಲ್ಲಾ ಪ್ರಕರಣಗಳು, ತೆರಿಗೆ ನಿಯಮಗಳು ಮತ್ತು 73ನೇ ಸಾಂವಿಧಾನಿಕ ತಿದ್ದುಪಡಿಯ ಅಧ್ಯಾಯವಾರು ಸಾರಾಂಶ.',
    contributorName: 'ರಾಘವೇಂದ್ರ ಜೋಶಿ (Raghavendra Joshi)',
    contributorDistrict: 'Vijayapura (ವಿಜಯಪುರ)',
    contributorBadge: 'Community Guide',
    fileUrl: 'https://rdpr.karnataka.gov.in/act_summary.pdf',
    fileType: 'pdf',
    fileSize: '5.1 MB',
    upvotes: 124,
    downloads: 830,
    ...
    tags: ['PDO Act 1993', 'RDPR', 'Panchayat Raj', 'Book Summary']
  },
  {
    id: 'comm_notes_kannada_grammar_master',
    title: 'KPSC FDA / SDA General Kannada 500+ Tatsama-Tadbhava & Samasa Master List',
    titleKn: 'KPSC FDA / SDA ಸಾಮಾನ್ಯ ಕನ್ನಡ 500+ ತತ್ಸಮ-ತದ್ಭವ ಮತ್ತು ಸಮಾಸಗಳ ಮಾಸ್ಟರ್ ಪಟ್ಟಿ',
    category: 'notes',
    examId: 'exam_fda_sda_2026',
    examName: 'FDA / SDA & KAS',
    examNameKn: 'ಎಫ್.ಡಿ.ಎ / ಎಸ್.ಡಿ.ಎ & ಗ್ರೂಪ್ ಸಿ',
    subject: 'Kannada Grammar & Literature',
    subjectKn: 'ಕನ್ನಡ ವ್ಯಾಕರಣ & ಸಾಹಿತ್ಯ',
    year: '2026',
    description: 'Handpicked master compilation of repeated Tatsama-Tadbhava, Dvirukti, Jodunudi, and Sandhi rules from the past 15 years of KPSC exams.',
    descriptionKn: 'ಕಳೆದ 15 ವರ್ಷಗಳ KPSC ಪರೀಕ್ಷೆಗಳಲ್ಲಿ ಪುನರಾವರ್ತನೆಯಾದ ಎಲ್ಲಾ ಪ್ರಮುಖ ತತ್ಸಮ-ತದ್ಭವಗಳು, ದ್ವಿರುಕ್ತಿ, ಜೋಡುನುಡಿ ಮತ್ತು ಸಂಧಿ ಪದಗಳ ನಿಖರ ಸಂಕಲನ.',
    contributorName: 'ಸುರೇಶ್ ನಾಯಕ್ (Suresh Nayak)',
    contributorDistrict: 'Shivamogga (ಶಿವಮೊಗ್ಗ)',
    contributorBadge: 'Faculty Member',
    fileUrl: 'https://kpsc.kar.nic.in/kannada_grammar_compilation.pdf',
    fileType: 'pdf',
    fileSize: '3.6 MB',
    upvotes: 187,
    downloads: 1240,
    ...
    tags: ['Kannada Grammar', 'Tatsama Tadbhava', 'FDA SDA', 'High Yield']
  },
  {
    id: 'comm_pyq_kas_2023',
    title: '2023 KPSC KAS Prelims Paper 1 & 2 Solved with Explanations',
    titleKn: '2023 KPSC KAS Prelims Paper 1 & 2 ಸಂಪೂರ್ಣ ವಿಶ್ಲೇಷಣೆ ಸಹಿತ ಪ್ರಶ್ನೋತ್ತರಗಳು',
    category: 'pyq',
    examId: 'exam_kas_2026',
    examName: 'KPSC KAS (Gazetted Probationers)',
    examNameKn: 'ಕೆ.ಪಿ.ಎಸ್.ಸಿ ಕೆ.ಎ.ಎಸ್',
    subject: 'General Studies Paper 1 & 2',
    subjectKn: 'ಸಾಮಾನ್ಯ ಅಧ್ಯಯನ ಪತ್ರಿಕೆ 1 & 2',
    year: '2023',
    description: 'Detailed analysis of all 200 questions of KAS 2023 Prelims with reference sources and official cut-off scores breakdown.',
    descriptionKn: 'ಕೆಎಎಸ್ ಪ್ರಿಲಿಮ್ಸ್ ಪರೀಕ್ಷೆಯ 200 ಪ್ರಶ್ನೆಗಳಿಗೆ ಅಧಿಕೃತ ಕೀ-ಉತ್ತರ, ರೆಫರೆನ್ಸ್ ಮೂಲಗಳು ಮತ್ತು ಕಟ್-ಆಫ್ ವಿವರಣೆ.',
    contributorName: 'ಅಕ್ಷಯ್ ಹೆಗಡೆ (Akshay Hegde)',
    contributorDistrict: 'Bengaluru (ಬೆಂಗಳೂರು)',
    contributorBadge: 'Verified Topper',
    fileUrl: 'https://kpsc.kar.nic.in/kas_2023_solved.pdf',
    fileType: 'pdf',
    fileSize: '6.4 MB',
    upvotes: 215,
    downloads: 1450,
    ...
    tags: ['KAS 2023', 'KPSC Prelims', 'Official Answer Key', 'Topper Analysis']
  }
];
