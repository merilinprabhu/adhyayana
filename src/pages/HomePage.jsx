              ...
              {subjects.slice(0, 6).map((subj) => {
                ...
                return (
                  <div
                    key={subj.id}
                    onClick={() => onNavigate('notes')}
                    className="group rounded-3xl border border-slate-200/90 dark:border-slate-800 bg-white dark:bg-slate-900 overflow-hidden hover:shadow-xl hover:border-emerald-500/80 transition-all cursor-pointer flex flex-col justify-between hover:-translate-y-1"
                  >
                    ...
                    <div className="p-4 space-y-3 flex-1 flex flex-col justify-between">
                      ...
                      <div className="pt-2.5 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between text-xs font-bold">
                        ...
                        <span className="text-emerald-600 dark:text-emerald-400 flex items-center gap-0.5 group-hover:translate-x-1 transition-transform">
                          <span>{lang === 'kn' ? 'ಪ್ರವೇಶಿಸಿ' : 'Explore'}</span>
                          <ChevronRight className="w-3.5 h-3.5" />
                        </span>
                      </div>
                    </div>
